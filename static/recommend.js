$(function() {
  ...
  $('.movie-button').on('click',function(){
    var my_api_key = '4be06f30f269243dbec10b6d0201f874';//API KEY
    var title = $('.movie').val();
    if (title=="") {
...
//It will be invoked when we click on the recommended movie cards
function recommendcard(e){
  $("#loader").fadeIn();
  var my_api_key = '4be06f30f269243dbec10b6d0201f874';
  var title = e.getAttribute('title'); 
  load_details(my_api_key,title);
}


// We will get the details of the movie from the API (based on the name of the movie)
...
// we are getting all the details of the movie using the movie id.
